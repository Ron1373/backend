 ...
 */ (function (e) {
  ...
  function r(N) {
    ...
    if (L !== O) {
      N[0] = L;
      e: for (var K = 0, G = N.length, mr = G >>> 1; K < mr; ) {
        var xt = 2 * (K + 1) - 1,
          Vl = N[xt],
          Ct = xt + 1,
          yr = N[Ct];
    ...
    (e.unstable_scheduleCallback = function (N, O, L) {
      ...
      return (
        ...
        L > K
          ...
          : ((N.sortIndex = G), t(s, N), v || w || ((v = !0), $l(k))),
        N
      );
    }),
...
var _a = Ee.unstable_scheduleCallback,
  Au = Ee.unstable_cancelCallback,
  fd = Ee.unstable_shouldYield,
  dd = Ee.unstable_requestPaint,
  X = Ee.unstable_now,
  pd = Ee.unstable_getCurrentPriorityLevel,
  Fi = Ee.unstable_ImmediatePriority,
  Na = Ee.unstable_UserBlockingPriority,
  Gr = Ee.unstable_NormalPriority,
  hd = Ee.unstable_LowPriority,
  Ra = Ee.unstable_IdlePriority,
  El = null,
  We = null;
function md(e) {
...
var yn = {
  ...
  Iu = xe(kl),
  Pd = H({}, kl, { dataTransfer: 0 }),
  Td = xe(Pd),
  Od = H({}, cr, { relatedTarget: 0 }),
  Zl = xe(Od),
  Ld = H({}, yn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  zd = xe(Ld),
  Fd = H({}, yn, {
...
var Bd = H({}, cr, {
  ...
  Wd = xe(Vd),
  Qd = H({}, yn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Kd = xe(Qd),
  Xd = H({}, kl, {
    deltaX: function (e) {
...
function Ha(e) {
  if (e.propertyName === "value" && xl(qn)) {
    var t = [];
    Ba(t, qn, e, zi(e)), Ea(ep, t);
  }
}
function np(e, t, n) {
  e === "focusin"
    ? (Ku(), (Un = t), (qn = n), Un.attachEvent("onpropertychange", Ha))
    : e === "focusout" && Ku();
}
function rp(e) {
...
var Ka = Cl("animationend"),
  Xa = Cl("animationiteration"),
  Ja = Cl("animationstart"),
  Ya = Cl("transitionend"),
  qa = new Map(),
  qu =
...
St(Xa, "onAnimationIteration");
St(Ja, "onAnimationStart");
St("dblclick", "onDoubleClick");
St("focusin", "onFocus");
St("focusout", "onBlur");
St(Ya, "onTransitionEnd");
...
function kt() {
  if (!uo && Xe !== null) {
    ...
    try {
      ...
      throw (Xe !== null && (Xe = Xe.slice(e + 1)), _a(Fi, kt), l);
    } finally {
      (A = t), (uo = !1);
    }
  }
...
var qt = [],
  ...
  Ye = "";
function _t(e, t) {
  (qt[Gt++] = il), (qt[Gt++] = ol), (ol = e), (il = t);
}
function tc(e, t, n) {
  (Ce[_e++] = Je), (Ce[_e++] = Ye), (Ce[_e++] = At), (At = e);
  var r = Je;
  e = Ye;
  var l = 32 - je(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function Vi(e) {
  for (; e === ol; )
    (ol = qt[--Gt]), (qt[Gt] = null), (il = qt[--Gt]), (qt[Gt] = null);
  for (; e === At; )
    (At = Ce[--_e]),
      (Ce[_e] = null),
      (Ye = Ce[--_e]),
...
var dl = {
  ...
  Rp = {
    ...
    useDeferredValue: function (e) {
      var t = Oe();
      return Y === null ? (t.memoizedState = e) : xc(t, Y.memoizedState, e);
    },
    useTransition: function () {
      var e = fo(lr)[0],
        t = Oe().memoizedState;
...
function gs(e, t, n, r, l) {
  ...
  if ((on(t, l), t.stateNode === null))
    ...
    u !== h || m !== v || he.current || ot
      ? (typeof w == "function" && (bo(t, n, w, r), (v = t.memoizedState)),
        (a = ot || fs(t, n, a, r, m, v, s) || !1)
          ? (f ||
...
function Bc(e) {
  ...
  t !== null && ((e.alternate = null), Bc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ve], delete t[er], delete t[Jo], delete t[vp], delete t[gp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Qc(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = yl(e, r);
    ...
    D |= 2;
    var o = Xc();
    (ee !== e || ne !== t) && ((Ke = null), (hn = X() + 500), Lt(e, t));
    do
      try {
        Bp();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = ir), Lt(e, 0), ut(e, r), ye(e, X()), n);
    if (t === 6) ut(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (ut(e, r), (r & 130023424) === r && ((t = uu + 500 - X()), 10 < t))
          ) {
            if (Zr(e, 0) !== 0) break;
...
function Rs(e) {
  ...
  if (n === 1) throw ((n = ir), Lt(e, 0), ut(e, t), ye(e, X()), n);
...
function yl(e, t) {
  ...
  while (!0);
  if ((Ki(), (D = n), (pl.current = r), J !== null)) throw Error(E(261));
...
function Hp(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    ee === e &&
      (ne & n) === n &&
      (q === 4 || (q === 3 && (ne & 130023424) === ne && 500 > X() - uu)
        ? Lt(e, 0)
        : (iu |= n)),
    ye(e, t);
}
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Di(t, n | 1), ye(t, X()), !(D & 6) && ((hn = X() + 500), kt()));
      }
      break;
    case 13:
      Ut(function () {
...
wa = su;
Sa = Ut;
var Gp = { usingClientEntryPoint: !1, Events: [fr, Jt, _l, va, ga, su] },
  Tn = {
...
const gh = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  Fs = "0123456789",
  ff = { DIGIT: Fs, ALPHA: vo, ALPHA_DIGIT: vo + vo.toUpperCase() + Fs },
  Dh = (e = 16, t = ff.ALPHA_DIGIT) => {
    let n = "";
    const { length: r } = t;
...
const jh = (e) => {
  ...
  Mh = Be("AsyncFunction"),
  Uh = (e) => e && (Ul(e) || Pe(e)) && Pe(e.then) && Pe(e.catch),
  y = {
    isArray: gn,
    isArrayBuffer: lf,
    isBuffer: nh,
...
function Bh(e) {
  return y.isArray(e) && !e.some(yi);
}
const $h = y.toFlatObject(y, {}, null, function (t) {
...
function Il(e, t, n) {
  ...
  function f(v, g, P) {
    ...
    return yi(v) ? !0 : (t.append(Ds(P, g, o), a(v)), !1);
  }
  const h = [],
    m = Object.assign($h, {
      defaultVisitor: f,
...
function yf(e, t, n) {
  ...
  if (
    (l
      ? (o = l(t, n))
      : (o = y.isURLSearchParams(t) ? t.toString() : new vu(t, n).toString(r)),
    o)
  ) {
    const i = e.indexOf("#");
    i !== -1 && (e = e.slice(0, i)),
...
const vf = {
  ...
  Vh = typeof URLSearchParams < "u" ? URLSearchParams : vu,
  Wh = typeof FormData < "u" ? FormData : null,
  ...
  Xh = ((e) => gu && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(
  ...
  Yh = (gu && window.location.href) || "http://localhost",
  qh = Object.freeze(
    ...
    return (
      ...
      s
        ...
        : ((!l[i] || !y.isObject(l[i])) && (l[i] = []),
          t(n, r, l[i], o) && y.isArray(l[i]) && (l[i] = bh(l[i])),
          !u)
    );
  }
...
class ve {
  ...
  set(t, n, r) {
    ...
    else if (y.isString(t) && (t = t.trim()) && !lm(t)) i(nm(t), n);
...
const kf = (e) => {
    ...
    if (
      ...
      (r && y.isFunction(r) && (r = r(t)), r || (r !== !1 && cm(t.url)))
    ) {
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        "onloadend" in f
          ...
          (f.onabort = function () {
            f &&
              (r(new T("Request aborted", T.ECONNABORTED, l, f)), (f = null));
          }),
          (f.onerror = function () {
  ...
  ym = (e, t) => {
    ...
    const l = function (s) {
      if (!r) {
        ...
        n.abort(
          a instanceof T ? a : new wn(a instanceof Error ? a.message : a)
        );
      }
    };
    let o =
  ...
  xf = Bl && typeof ReadableStream == "function",
  vi =
    Bl &&
    ...
    (async (e) => {
      ...
      try {
        ...
        if (gi && (u || S)) {
          ...
          p = new Response(
            Is(p.body, $s, u && Bs(_, gl(u, !0)), S && d, vi),
            x
          );
        }
        a = a || "text";
...
const Hs = (e) => `- ${e}`,
  xm = (e) => y.isFunction(e) || e === null || e === !1,
  Cf = {
    getAdapter: (e) => {
      e = y.isArray(e) ? e : [e];
      const { length: t } = e;
...
W.mergeConfig = It;
W.AxiosHeaders = ve;
W.formToJSON = (e) => gf(y.isHTMLForm(e) ? new FormData(e) : e);
W.getAdapter = Cf.getAdapter;
W.HttpStatusCode = Ei;
W.default = W;
const Eu = "http://localhost:3001/api/notes",
  Rm = () => {
    const e = W.get(Eu),
      t = {
        id: 1e4,
  ...
  Pm = (e) => W.post(Eu, e).then((t) => t.data),
  Tm = (e, t) => W.put(`${Eu}/${e}`, t).then((n) => n.data),
  Eo = { getAll: Rm, create: Pm, update: Tm },
  Om = ({ message: e }) =>
  ...
  zm = () => {
    ...
    const s = (m) => {
      ...
      a = (m) => {
        const w = e.find((g) => g.id === m),
          v = { ...w, important: !w.important };
        Eo.update(m, v)
          .then((g) => {
            t(e.map((P) => (P.id !== m ? P : g)));
          })
          .catch((g) => {
    ...
    return Z.jsxs("div", {
      children: [
        ...
        Z.jsx("ul", {
          children: h.map((m) =>
            Z.jsx(eh, { note: m, toggleImportance: () => a(m.id) }, m.id)
          ),
        }),
        Z.jsxs("form", {
          onSubmit: s,
...
ko.createRoot(document.getElementById("root")).render(Z.jsx(zm, {}));
